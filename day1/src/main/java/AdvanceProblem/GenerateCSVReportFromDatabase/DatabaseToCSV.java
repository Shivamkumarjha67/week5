package AdvanceProblem.GenerateCSVReportFromDatabase;
...
public class DatabaseToCSV {
    public static void main(String[] args) {
        String jdbcUrl = "jdbc:mysql://localhost:300/sql_MH452";
        String username = "shivam567";
        String password = "shkrjh@345";
